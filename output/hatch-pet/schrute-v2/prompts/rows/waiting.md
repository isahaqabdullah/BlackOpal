Create a single horizontal sprite strip for the Codex app digital pet `schrute` in the state `waiting`.
...
- Make waiting feel impatient and suspicious: side-eye, tiny foot tap, beet inspection, and a return to rigid stance.
- Avoid generic breathing-only frames.
- Keep all movement small but characterful.
