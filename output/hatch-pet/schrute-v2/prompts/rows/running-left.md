Create a single horizontal sprite strip for the Codex app digital pet `schrute` in the state `running-left`.
...
- Make this a determined left-facing power-walk/march rather than a cute jog.
