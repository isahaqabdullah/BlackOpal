Create a single horizontal sprite strip for the Codex app digital pet `schrute` in the state `running`.
...
- Make the generic running row a front-facing marching-in-place drill.
- Use high knees, stiff arms, serious eyes, and the beet held close.
- No speed lines, dust, floor shadows, or trails.
