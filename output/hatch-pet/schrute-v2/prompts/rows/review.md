Create a single horizontal sprite strip for the Codex app digital pet `schrute` in the state `review`.
...
- Make review read as intense quality inspection: lean in, adjust glasses, narrow eyes, tilt head, and hold the beet up for scrutiny.
- Do not add magnifying glasses, papers, UI, punctuation, code, or new props.
- Keep the focus visible through pose and expression only.
