        ...
        <div className="premium-shell">
          <div className="premium-panel premium-split-grid p-7 md:p-9">
            ...
            <div>
              ...
              <div
                className="space-y-4 premium-copy text-[16px] leading-[1.85] mb-8"
                    ...
                    >
                      ...
                      {office.address.map((line) => (
                        <p
                          ...
                          className="premium-copy text-[16px] leading-[1.65]"
                          style={{ fontFamily: 'Inter, sans-serif', fontWeight: 300 }}
                        >
                          {line}
                        </p>
          ...
          <div className="premium-shell">
            <div className="premium-panel-soft p-6 md:p-7">
              ...
              <p
                ...
                className="premium-copy text-[16px] leading-[1.8] mb-5 max-w-3xl"
                style={{ fontFamily: 'Inter, sans-serif', fontWeight: 300 }}
              >
