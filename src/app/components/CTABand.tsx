    ...
    <section className="py-10 md:py-12">
      <div className="premium-shell">
        ...
        >
          ...
          <h2
            data-sanity={homePageDataAttribute('ctaTitle', homePageDocumentId)}
          ...
          <p
            data-sanity={homePageDataAttribute('ctaDescription', homePageDocumentId)}
          ...
          <div className="premium-reveal premium-reveal-delay-2 flex flex-wrap justify-center gap-3 relative z-10">
            <Link
              data-sanity={homePageDataAttribute('ctaPrimaryLabel', homePageDocumentId)}
              to="/contact"
            ...
            <Link
              data-sanity={homePageDataAttribute('ctaSecondaryLabel', homePageDocumentId)}
              to="/contact"
