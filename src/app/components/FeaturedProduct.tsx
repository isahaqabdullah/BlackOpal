      ...
      <div className="premium-shell">
        <div className="premium-panel premium-split-grid p-8 md:p-10 lg:p-12">
          <div>
            ...
            <h2
              className="premium-heading text-[clamp(1.9rem,3.8vw,3.4rem)] leading-[1.02] tracking-[-0.02em] mb-6"
          ...
          <div className="premium-image-frame w-full max-w-[42rem] xl:justify-self-end">
            <img
